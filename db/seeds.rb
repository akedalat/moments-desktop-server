...
u1 = User.create(name:"John", username:"john", password:"123", email:"john@flatiron.com")
u2 = User.create(name:"Tommy Angelo", username:"tommy", password:"123", email:"tommy@flatiron.com", avatar:"http://localhost:3000/tommy.jpg")
u3 = User.create(name:"Vito Scaletta", username:"vito", password:"123", email:"vito@flatiron.com", avatar:"http://localhost:3000/vito.jpg")
u4 = User.create(name:"Sofia", password:"123", username:"sofia", email:"sofia@flatiron.com", avatar:"http://localhost:3000/sofia.jpg")
u5 = User.create(name:"Daniel", password:"123", username:"daniel", email:"daniel@flatiron.com", avatar:"http://localhost:3000/dan.jpg")
u6 = User.create(name:"ana", password:"123", username:"ana", email:"ana@flatiron.com", avatar:"http://localhost:3000/ana.jpg")
u7 = User.create(name:"Sarah Jacob", password:"123", username:"sarah", email:"sarah@flatiron.com", avatar:"http://localhost:3000/sarah.jpg")
u8 = User.create(name:"Stuart Sewell", password:"123", username:"stuart", email:"stuart@flatiron.com", avatar:"http://localhost:3000/stu.jpg")
u9 = User.create(name:"Sam Baker", password:"123", username:"sam", email:"sam@flatiron.com", avatar:"http://localhost:3000/sam.jpg")
u10 = User.create(name:"Gabriel", password:"123", username:"gabriel", email:"gabriel@flatiron.com", avatar:"http://localhost:3000/gab.jpg")
